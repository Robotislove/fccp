...
class RoomExplorationFeedback {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new RoomExplorationFeedback(null);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new RoomExplorationFeedback(null);
    return resolved;
    }
};

module.exports = RoomExplorationFeedback;
